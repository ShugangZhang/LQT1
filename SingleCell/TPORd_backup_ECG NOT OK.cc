...
public:
	...
	void update()
	{
		...
		*/
		...
		#ifdef ISO1
		PCa *= 1.3;//test Glory - case study  1.3    // 2.1 Ok 2.2
		#endif
		...
		// #ifdef ISO
		// PCa *= 2.5; // O'hara et al. 2012. Heart Rhythm  // safe critical 3.8(LQT1000) (LQT500)  4.6(CON1000) 
		// #endif
		// safe critical around 18 (CON1000)      around 16 (LQT1000)
