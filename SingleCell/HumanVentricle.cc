...
private:
	...
	// ***********constants*************
	static const double nao=140.0;//extracellular sodium in mM
	static const double cao=1.8;//extracellular calcium in mM
	static const double ko=5.4;//extracellular potassium in mM

	//buffer paramaters
	static const double BSRmax=0.047;
	static const double KmBSR=0.00087;
	static const double BSLmax=1.124;
	static const double KmBSL=0.0087;
	static const double cmdnmax=0.05;
	static const double kmcmdn=0.00238;
	static const double trpnmax=0.07;
	static const double kmtrpn=0.0005;
	static const double csqnmax=10.0;
	static const double kmcsqn=0.8;

	//CaMK paramaters
	static const double aCaMK = 0.05;
	static const double bCaMK = 0.00068;
	static const double CaMKo = 0.05;
	static const double KmCaM = 0.0015;
	static const double KmCaMK = 0.15;

	//physical constants
	static const double R=8314.0;
	static const double T=310.0;
	static const double F=96485.0;

	//cell geometry
	static const double L = 0.01;
	static const double rad = 0.0011;
	static const double vcell = 1000*3.14*0.0011*0.0011*0.01; //1000*3.14*rad*rad*L;
	static const double Ageo = 2*3.14*0.0011*0.0011 + 2*3.14*0.0011*0.01; //2*3.14*rad*rad+2*3.14*rad*L
	static const double Acap = 2 * (2*3.14*0.0011*0.0011 + 2*3.14*0.0011*0.01); //2*Ageo;
	static const double vmyo = 0.68 * (1000*3.14*0.0011*0.0011*0.01); //0.68*vcell;
	static const double vmito = 0.26 * (1000*3.14*0.0011*0.0011*0.01); // 0.26*vcell
	static const double vsr = 0.06 * (1000*3.14*0.0011*0.0011*0.01); //0.06 * vcell;
	static const double vnsr = 0.0552 * (1000*3.14*0.0011*0.0011*0.01); // 0.0552 * vcell;
	static const double vjsr = 0.0048 * (1000*3.14*0.0011*0.0011*0.01); // 0.0048 * vcell;
	static const double vss = 0.02 * (1000*3.14*0.0011*0.0011*0.01); // 0.02 * vcell;
